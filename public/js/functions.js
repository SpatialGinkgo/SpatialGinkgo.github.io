...
window.onscroll = () => {
	...
	let banner = document.querySelector('#sec_banner');
	let posicion = document.documentElement.scrollTop;

	if(posicion < banner.offsetHeight) {
		
		if(posicion < banner.offsetHeight-50) {
			header.classList.add('oculto');
			header.classList.remove('oculto_fade');
		}else{
			header.classList.add('oculto_fade');
			header.classList.remove('oculto');
			header.classList.remove('fade_h');
		}
	} else {
		header.classList.remove('oculto');
		header.classList.add('fade_h');
		header.classList.remove('oculto_fade');
	}
};
